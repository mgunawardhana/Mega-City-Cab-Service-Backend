...
public class DriverServiceImpl implements DriverService {
    ...
    public ResponseEntity<APIResponse> getDriverById(String driverRegNo) {
        try{
            Driver driver = readJdbcTemplate.queryForObject(SqlQuery.SelectQuery.GET_DRIVER_BY_NIC, new Object[]{driverRegNo}, (rs, rowNum) -> Driver.builder()
    ...
    public ResponseEntity<APIResponse> deleteDriverById(String licenseNumber) {
        try{
            writeJdbcTemplate.update(SqlQuery.DeleteQuery.DELETE_DRIVER_BY_LICENSE_NUMBER, licenseNumber);
